...
for i in range(n):
    while True:
        t = input(f'ответ  {i + 1} должен быть в Формате |час:минута:cекунда| - ')
        try:
            valid_time = datetime.datetime.strptime(t, '%H:%M:%S')
            ...
            print(f'формат времени {t} неправильный !!. вводите в формате - |час:минута:cекунда| ')
hlist = []
mlist = []
slist = []
